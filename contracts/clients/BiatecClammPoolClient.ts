...
export const APP_SPEC: Arc56Contract = {"name":"BiatecClammPool","desc":"","methods":[{"name":"createApplication","desc":"Initial setup","args":[],"returns":{"type":"void"},"actions":{"create":["NoOp"],"call":[]}},{"name":"updateApplication","desc":"addressUdpater from global biatec configuration is allowed to update application","args":[{"name":"appBiatecConfigProvider","type":"uint64"},{"name":"newVersion","type":"byte[]"}],"returns":{"type":"void"},"actions":{"create":[],"call":["UpdateApplication"]}},{"name":"getCurrentPrice","readonly":true,"args":[],"returns":{"type":"uint64"},"actions":{"create":[],"call":["NoOp"]}},{"name":"getPriceDivider","readonly":true,"args":[],"returns":{"type":"uint64"},"actions":{"create":[],"call":["NoOp"]}},{"name":"getLPTokenId","readonly":true,"args":[],"returns":{"type":"uint64"},"actions":{"create":[],"call":["NoOp"]}},{"name":"bootstrap","desc":"Only Biatec Pool Provider can deploy and bootsrap this smart contract","args":[{"name":"assetA","type":"uint64","desc":"Asset A ID must be lower then Asset B ID"},{"name":"assetB","type":"uint64","desc":"Asset B"},{"name":"appBiatecConfigProvider","type":"uint64","desc":"Biatec amm provider"},{"name":"appBiatecPoolProvider","type":"uint64","desc":"Pool provider"},{"name":"txSeed","type":"pay","desc":"Seed transaction so that smart contract can opt in to the assets"},{"name":"fee","type":"uint64","desc":"Fee in base level (9 decimals). value 1_000_000_000 = 1 = 100%. 10_000_000 = 1%. 1_000_000 = 0.1%"},{"name":"priceMin","type":"uint64","desc":"Min price range. At this point all assets are in asset A."},{"name":"priceMax","type":"uint64","desc":"Max price range. At this point all assets are in asset B."},{"name":"currentPrice","type":"uint64","desc":"Deployer can specify the current price for easier deployemnt."},{"name":"verificationClass","type":"uint64","desc":"Minimum verification level from the biatec identity. Level 0 means no kyc."}],"returns":{"type":"uint64","desc":"LP token ID"},"actions":{"create":[],"call":["NoOp"]}},{"name":"bootstrapStep2","desc":"When we know the app id of this pool, we can register it properly at the pool provider","args":[],"returns":{"type":"void"},"actions":{"create":[],"call":["NoOp"]}},{"name":"addLiquidity","desc":"This method adds Asset A and Asset B to the Automated Market Maker Concentrated Liqudidity Pool and send to the liqudidty provider the liquidity token","args":[{"name":"appBiatecConfigProvider","type":"uint64","desc":"Configuration reference"},{"name":"appBiatecIdentityProvider","type":"uint64","desc":"Identity service reference"},{"name":"txAssetADeposit","type":"txn","desc":"Transfer of asset A to the LP pool"},{"name":"txAssetBDeposit","type":"txn","desc":"Transfer of asset B to the LP pool"},{"name":"assetA","type":"uint64","desc":"Asset A"},{"name":"assetB","type":"uint64","desc":"Asset B"},{"name":"assetLp","type":"uint64","desc":"Liquidity pool asset"}],"returns":{"type":"uint64","desc":"LP Token quantity distributed"},"actions":{"create":[],"call":["NoOp"]}},{"name":"removeLiquidity","desc":"This method retrieves from the liquidity provider LP token and returns Asset A and Asset B from the Automated Market Maker Concentrated Liqudidity Pool","args":[{"name":"appBiatecConfigProvider","type":"uint64","desc":"Configuration reference"},{"name":"appBiatecIdentityProvider","type":"uint64","desc":"Identity service reference"},{"name":"txLpXfer","type":"axfer","desc":"Transfer of the LP token"},{"name":"assetA","type":"uint64","desc":"Asset A"},{"name":"assetB","type":"uint64","desc":"Asset B"},{"name":"assetLp","type":"uint64","desc":"LP pool asset"}],"returns":{"type":"uint256","desc":"LP position reduced"},"actions":{"create":[],"call":["NoOp"]}},{"name":"removeLiquidityAdmin","desc":"This method allows biatec admin to reduce the lp position created by lp fees allocation.\n\n\nOnly addressExecutiveFee is allowed to execute this method.","args":[{"name":"appBiatecConfigProvider","type":"uint64","desc":"Biatec config app. Only addressExecutiveFee is allowed to execute this method."},{"name":"assetA","type":"uint64","desc":"Asset A"},{"name":"assetB","type":"uint64","desc":"Asset B"},{"name":"assetLp","type":"uint64"},{"name":"amount","type":"uint256","desc":"Amount to withdraw. If zero, removes all available lps from fees."}],"returns":{"type":"uint256","desc":"LP position reduced"},"actions":{"create":[],"call":["NoOp"]}},{"name":"swap","desc":"Swap Asset A to Asset B or Asset B to Asst A","args":[{"name":"appBiatecConfigProvider","type":"uint64"},{"name":"appBiatecIdentityProvider","type":"uint64"},{"name":"appBiatecPoolProvider","type":"uint64"},{"name":"txSwap","type":"txn","desc":"Transfer of the token to be deposited to the pool. To the owner the other asset will be sent."},{"name":"assetA","type":"uint64","desc":"Asset A"},{"name":"assetB","type":"uint64","desc":"Asset B"},{"name":"minimumToReceive","type":"uint64","desc":"If number greater then zero, the check is performed for the output of the other asset"}],"returns":{"type":"uint256"},"actions":{"create":[],"call":["NoOp"]}},{"name":"distributeExcessAssets","desc":"If someone deposits excess assets to the LP pool, addressExecutiveFee can either distribute them to the lp tokens or withdraw it, depending on the use case.\nIf someone sent there assets in fault, the withrawing can be use to return them back. If the pool received assets for example for having its algo stake online and recieved rewards it is prefered to distribute them to the current LP holders.\n\n\nThis method is used to distribute amount a and amount b of asset a and asset b to holders as the fee income.\n\n\nOnly addressExecutiveFee is allowed to execute this method.","args":[{"name":"appBiatecConfigProvider","type":"uint64","desc":"Biatec config app. Only addressExecutiveFee is allowed to execute this method."},{"name":"assetA","type":"uint64","desc":"Asset A"},{"name":"assetB","type":"uint64","desc":"Asset B"},{"name":"amountA","type":"uint256","desc":"Amount of asset A to be deposited to the liquidity. In base decimals (9)"},{"name":"amountB","type":"uint256","desc":"Amount of asset B to be deposited to the liquidity. In base decimals (9)"}],"returns":{"type":"uint256"},"actions":{"create":[],"call":["NoOp"]}},{"name":"withdrawExcessAssets","desc":"If someone deposits excess assets to the LP pool, addressExecutiveFee can either distribute them to the lp tokens or withdraw it, depending on the use case.\nIf someone sent there assets in fault, the withrawing can be use to return them back. If the pool received assets for example for having its algo stake online and recieved rewards it is prefered to distribute them to the current LP holders.\n\n\nThis method is used to distribute amount a and amount b of asset a and asset b to addressExecutiveFee account.\n\n\nOnly addressExecutiveFee is allowed to execute this method.","args":[{"name":"appBiatecConfigProvider","type":"uint64","desc":"Biatec config app. Only addressExecutiveFee is allowed to execute this method."},{"name":"assetA","type":"uint64","desc":"Asset A"},{"name":"assetB","type":"uint64","desc":"Asset B"},{"name":"amountA","type":"uint64","desc":"Amount of asset A to be deposited to the liquidity. In asset a decimals"},{"name":"amountB","type":"uint64","desc":"Amount of asset B to be deposited to the liquidity. In asset b decimals"}],"returns":{"type":"uint64"},"actions":{"create":[],"call":["NoOp"]}},{"name":"sendOnlineKeyRegistration","desc":"addressExecutiveFee can perfom key registration for this LP pool\n\n\nOnly addressExecutiveFee is allowed to execute this method.","args":[{"name":"appBiatecConfigProvider","type":"uint64"},{"name":"votePk","type":"byte[]"},{"name":"selectionPk","type":"byte[]"},{"name":"stateProofPk","type":"byte[]"},{"name":"voteFirst","type":"uint64"},{"name":"voteLast","type":"uint64"},{"name":"voteKeyDilution","type":"uint64"},{"name":"fee","type":"uint64"}],"returns":{"type":"void"},"actions":{"create":[],"call":["NoOp"]}},{"name":"calculateDistributedLiquidity","desc":"addressExecutiveFee can perfom key unregistration for this LP pool\n\n\nOnly addressExecutiveFee is allowed to execute this method.","readonly":true,"args":[{"name":"assetLp","type":"uint64"},{"name":"currentDeposit","type":"uint256"}],"returns":{"type":"uint256"},"actions":{"create":[],"call":["NoOp"]}},{"name":"calculateLiquidityFlatPrice","readonly":true,"args":[{"name":"x","type":"uint256"},{"name":"y","type":"uint256"},{"name":"price","type":"uint256"}],"returns":{"type":"uint256"},"actions":{"create":[],"call":["NoOp"]}},{"name":"calculateLiquidityD","desc":"Calculates the liquidity  from the x - Asset A position and y - Asset B position\nThis method calculates discriminant - first part of the calculation.\nIt is divided so that the readonly method does not need to charge fees","readonly":true,"args":[{"name":"x","type":"uint256","desc":"Asset A position balanced on the curve"},{"name":"y","type":"uint256","desc":"Asset B position balanced on the curve"},{"name":"priceMin","type":"uint256","desc":"Minimum price variable in base scale decimals (pa)"},{"name":"priceMax","type":"uint256","desc":"Maximum price variable in base scale decimals (pb)"},{"name":"priceMinSqrt","type":"uint256","desc":"sqrt(priceMin) in base scale decimals Variable pas"},{"name":"priceMaxSqrt","type":"uint256","desc":"sqrt(priceMax) in base scale decimals Variable pbs"}],"returns":{"type":"uint256","desc":"Liquidity is constant in swapping each direction. On deposit the diff between the liquidity is number of LP tokens received by user."},"actions":{"create":[],"call":["NoOp"]}},{"name":"calculateLiquidityWithD","desc":"Calculates the liquidity  from the x - Asset A position and y - Asset B position","readonly":true,"args":[{"name":"x","type":"uint256","desc":"Asset A position balanced on the curve"},{"name":"y","type":"uint256","desc":"Asset B position balanced on the curve"},{"name":"priceMinSqrt","type":"uint256","desc":"sqrt(priceMin) in base scale decimals Variable pas"},{"name":"priceMaxSqrt","type":"uint256","desc":"sqrt(priceMax) in base scale decimals Variable pbs"},{"name":"dSqrt","type":"uint256"}],"returns":{"type":"uint256","desc":"Liquidity is constant in swapping each direction. On deposit the diff between the liquidity is number of LP tokens received by user."},"actions":{"create":[],"call":["NoOp"]}},{"name":"calculatePrice","desc":"Get the current price when asset a has x","readonly":true,"args":[{"name":"assetAQuantity","type":"uint256","desc":"x"},{"name":"assetBQuantity","type":"uint256","desc":"y"},{"name":"priceMinSqrt","type":"uint256","desc":"sqrt(priceMin)"},{"name":"priceMaxSqrt","type":"uint256","desc":"sqrt(priceMax)"},{"name":"liquidity","type":"uint256","desc":"Current pool liquidity - L variable"}],"returns":{"type":"uint256","desc":"the price with specified quantity with the price range set in the contract"},"actions":{"create":[],"call":["NoOp"]}},{"name":"calculateAssetBWithdrawOnAssetADeposit","desc":"Calculates how much asset B will be taken from the smart contract on asset A deposit","readonly":true,"args":[{"name":"inAmount","type":"uint256","desc":"Asset A amount in Base decimal representation.. If asset has 6 decimals, 1 is represented as 1000000000"},{"name":"assetABalance","type":"uint256","desc":"Asset A balance. Variable ab, in base scale"},{"name":"assetBBalance","type":"uint256","desc":"Asset B balance. Variable bb, in base scale"},{"name":"priceMinSqrt","type":"uint256","desc":"sqrt(Min price). Variable pMinS, in base scale"},{"name":"priceMaxSqrt","type":"uint256","desc":"sqrt(Max price). Variable pMaxS, in base scale"},{"name":"liquidity","type":"uint256","desc":"sqrt(Max price). Variable L, in base scale"}],"returns":{"type":"uint256","desc":"Amount of asset B to be given to the caller before fees. The result is in Base decimals (9)"},"actions":{"create":[],"call":["NoOp"]}},{"name":"calculateAssetAWithdrawOnAssetBDeposit","desc":"Calculates how much asset A will be taken from the smart contract on asset B deposit","readonly":true,"args":[{"name":"inAmount","type":"uint256","desc":"Asset B amount in Base decimal representation.. If asset has 6 decimals, 1 is represented as 1000000000"},{"name":"assetABalance","type":"uint256","desc":"Asset A balance. Variable ab, in base scale"},{"name":"assetBBalance","type":"uint256","desc":"Asset B balance. Variable bb, in base scale"},{"name":"priceMinSqrt","type":"uint256","desc":"sqrt(Min price). Variable pMinS, in base scale"},{"name":"priceMaxSqrt","type":"uint256","desc":"sqrt(Max price). Variable pMaxS, in base scale"},{"name":"liquidity","type":"uint256","desc":"sqrt(Max price). Variable L, in base scale"}],"returns":{"type":"uint256","desc":"Amount of asset A to be given to the caller before fees. The result is in Base decimals (9)"},"actions":{"create":[],"call":["NoOp"]}},{"name":"calculateAssetAWithdrawOnLpDeposit","desc":"Calculates how much asset A will be taken from the smart contract on LP asset deposit","readonly":true,"args":[{"name":"inAmount","type":"uint256","desc":"LP Asset amount in Base decimal representation.."},{"name":"assetABalance","type":"uint256","desc":"Asset A balance. Variable ab, in base scale"},{"name":"liquidity","type":"uint256","desc":"Current liquidity. Variable L, in base scale"}],"returns":{"type":"uint256","desc":"Amount of asset A to be given to the caller before fees. The result is in Base decimals (9)"},"actions":{"create":[],"call":["NoOp"]}},{"name":"calculateAssetBDepositOnAssetADeposit","desc":"Calculates how much asset B should be deposited when user deposit asset a and b.\n\n\nOn deposit min(calculateAssetBDepositOnAssetADeposit, calculateAssetADepositOnAssetBDeposit) should be considered for the real deposit and rest should be swapped or returned back to user","readonly":true,"args":[{"name":"inAmountA","type":"uint256","desc":"Asset A amount in Base decimal representation"},{"name":"inAmountB","type":"uint256","desc":"Asset B amount in Base decimal representation"},{"name":"assetABalance","type":"uint256","desc":"Asset A balance. Variable ab, in base scale"},{"name":"assetBBalance","type":"uint256","desc":"Asset B balance. Variable bb, in base scale"}],"returns":{"type":"uint256","desc":"Amount of asset B to be given to the caller before fees. The result is in Base decimals (9)"},"actions":{"create":[],"call":["NoOp"]}},{"name":"calculateAssetADepositOnAssetBDeposit","desc":"Calculates how much asset A should be deposited when user deposit asset a and b\n\n\nOn deposit min(calculateAssetBDepositOnAssetADeposit, calculateAssetADepositOnAssetBDeposit) should be considered for the real deposit and rest should be swapped or returned back to user","readonly":true,"args":[{"name":"inAmountA","type":"uint256","desc":"Asset A amount in Base decimal representation"},{"name":"inAmountB","type":"uint256","desc":"Asset B amount in Base decimal representation"},{"name":"assetABalance","type":"uint256","desc":"Asset A balance. Variable ab, in base scale"},{"name":"assetBBalance","type":"uint256","desc":"Asset B balance. Variable bb, in base scale"}],"returns":{"type":"uint256","desc":"Amount of asset A to be deposited. The result is in Base decimals (9)"},"actions":{"create":[],"call":["NoOp"]}},{"name":"status","readonly":true,"args":[{"name":"appBiatecConfigProvider","type":"uint64"},{"name":"assetA","type":"uint64"},{"name":"assetB","type":"uint64"},{"name":"assetLp","type":"uint64"}],"returns":{"type":"(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64)","struct":"AmmStatus"},"actions":{"create":[],"call":["NoOp"]}}],"arcs":[4,56],"structs":{"AmmStatus":[{"name":"scale","type":"uint64"},{"name":"assetABalance","type":"uint64"},{"name":"assetBBalance","type":"uint64"},{"name":"realABalance","type":"uint64"},{"name":"realBBalance","type":"uint64"},{"name":"priceMinSqrt","type":"uint64"},{"name":"priceMaxSqrt","type":"uint64"},{"name":"currentLiquidity","type":"uint64"},{"name":"releasedLiquidity","type":"uint64"},{"name":"liquidityUsersFromFees","type":"uint64"},{"name":"liquidityBiatecFromFees","type":"uint64"},{"name":"assetA","type":"uint64"},{"name":"assetB","type":"uint64"},{"name":"poolToken","type":"uint64"},{"name":"price","type":"uint64"},{"name":"fee","type":"uint64"},{"name":"biatecFee","type":"uint64"},{"name":"verificationClass","type":"uint64"}]},"state":{"schema":{"global":{"bytes":11,"ints":10},"local":{"bytes":0,"ints":0}},"keys":{"global":{"setupFinished":{"key":"cw==","keyType":"AVMBytes","valueType":"bool"},"assetA":{"key":"YQ==","keyType":"AVMBytes","valueType":"uint64"},"assetADecimalsScaleFromBase":{"key":"YWQ=","keyType":"AVMBytes","valueType":"uint256"},"assetB":{"key":"Yg==","keyType":"AVMBytes","valueType":"uint64"},"assetBDecimalsScaleFromBase":{"key":"YmQ=","keyType":"AVMBytes","valueType":"uint256"},"assetLp":{"key":"bHA=","keyType":"AVMBytes","valueType":"uint64"},"assetABalanceBaseScale":{"key":"YWI=","keyType":"AVMBytes","valueType":"uint256"},"assetBBalanceBaseScale":{"key":"YmI=","keyType":"AVMBytes","valueType":"uint256"},"priceMin":{"key":"cE1pbg==","keyType":"AVMBytes","valueType":"uint64"},"priceMax":{"key":"cE1heA==","keyType":"AVMBytes","valueType":"uint64"},"priceMinSqrt":{"key":"cE1pblM=","keyType":"AVMBytes","valueType":"uint256"},"priceMaxSqrt":{"key":"cE1heFM=","keyType":"AVMBytes","valueType":"uint256"},"Liquidity":{"key":"TA==","keyType":"AVMBytes","valueType":"uint256"},"LiquidityUsersFromFees":{"key":"THU=","keyType":"AVMBytes","valueType":"uint256"},"LiquidityBiatecFromFees":{"key":"TGI=","keyType":"AVMBytes","valueType":"uint256"},"fee":{"key":"Zg==","keyType":"AVMBytes","valueType":"uint64"},"currentPrice":{"key":"cHJpY2U=","keyType":"AVMBytes","valueType":"uint64"},"scale":{"key":"c2NhbGU=","keyType":"AVMBytes","valueType":"uint64"},"appBiatecConfigProvider":{"key":"YmM=","keyType":"AVMBytes","valueType":"uint64"},"verificationClass":{"key":"Yw==","keyType":"AVMBytes","valueType":"uint64"},"version":{"key":"c2N2ZXI=","keyType":"AVMBytes","valueType":"AVMBytes"}},"local":{},"box":{}},"maps":{"global":{},"local":{},"box":{}}},"bareActions":{"create":[],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[426],"errorMessage":"The requested action is not implemented in this contract. Are you using the correct OnComplete? Did you set your app ID?","teal":25},{"pc":[511],"errorMessage":"E_CONFIG","teal":130},{"pc":[518],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('u')","teal":139},{"pc":[526],"errorMessage":"E_UPDATER","teal":149},{"pc":[621],"errorMessage":"argument 5 (txSeed) for bootstrap must be a pay transaction","teal":272},{"pc":[657],"errorMessage":"Only the pool provider can init this contract","teal":326},{"pc":[665],"errorMessage":"transaction verification failed: {\"txn\":\"txSeed\",\"field\":\"receiver\",\"expected\":\"this.app.address\"}","teal":337},{"pc":[675],"errorMessage":"transaction verification failed: {\"txn\":\"txSeed\",\"field\":\"amount\",\"condition\":\"greaterThanEqualTo\",\"expected\":\">=400_000\"}","teal":346},{"pc":[681],"errorMessage":"E_PRICE_MAX","teal":356},{"pc":[691],"errorMessage":"E_SENDER","teal":367},{"pc":[696],"errorMessage":"E_PRICE","teal":376},{"pc":[702],"errorMessage":"Asset A must not be asset B","teal":385},{"pc":[759],"errorMessage":"E_FEE","teal":450},{"pc":[765],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('p')","teal":459},{"pc":[773],"errorMessage":"E_CONFIG","teal":472},{"pc":[779],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('s')","teal":481},{"pc":[786],"errorMessage":"E_PAUSED","teal":491},{"pc":[814],"errorMessage":"sqrt((priceMin as uint256) * s) overflowed 256 bits","teal":525},{"pc":[837],"errorMessage":"sqrt((priceMax as uint256) * s) overflowed 256 bits","teal":551},{"pc":[968],"errorMessage":"assetADelicmalScale2Scale overflowed 256 bits","teal":697},{"pc":[987],"errorMessage":"assetBDelicmalScale2Scale overflowed 256 bits","teal":719},{"pc":[1033],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('p')","teal":782},{"pc":[1257],"errorMessage":"assetA does not match","teal":1080},{"pc":[1264],"errorMessage":"assetB does not match","teal":1090},{"pc":[1282],"errorMessage":"assetLp does not match","teal":1111},{"pc":[1470],"errorMessage":"failed to cast txAssetADeposit to axfer","teal":1309},{"pc":[1480],"errorMessage":"transaction verification failed: {\"txn\":\"xfer\",\"field\":\"typeEnum\",\"expected\":\"axfer\"}","teal":1325},{"pc":[1488],"errorMessage":"transaction verification failed: {\"txn\":\"xfer\",\"field\":\"assetReceiver\",\"expected\":\"this.app.address\"}","teal":1334},{"pc":[1496],"errorMessage":"transaction verification failed: {\"txn\":\"xfer\",\"field\":\"xferAsset\",\"expected\":\"assetA\"}","teal":1343},{"pc":[1503],"errorMessage":"transaction verification failed: {\"txn\":\"xfer\",\"field\":\"assetAmount\",\"condition\":\"greaterThanEqualTo\",\"expected\":\">=0\"}","teal":1352},{"pc":[1523],"errorMessage":"failed to cast txAssetADeposit to pay","teal":1374},{"pc":[1532],"errorMessage":"transaction verification failed: {\"txn\":\"payTx\",\"field\":\"typeEnum\",\"expected\":\"pay\"}","teal":1389},{"pc":[1540],"errorMessage":"transaction verification failed: {\"txn\":\"payTx\",\"field\":\"receiver\",\"expected\":\"this.app.address\"}","teal":1398},{"pc":[1547],"errorMessage":"transaction verification failed: {\"txn\":\"payTx\",\"field\":\"amount\",\"condition\":\"greaterThanEqualTo\",\"expected\":\">=0\"}","teal":1407},{"pc":[1552],"errorMessage":"Unsupported tx type of the asset A","teal":1416},{"pc":[1618],"errorMessage":"failed to cast txAssetBDeposit to axfer","teal":1486},{"pc":[1628],"errorMessage":"transaction verification failed: {\"txn\":\"xfer\",\"field\":\"typeEnum\",\"expected\":\"axfer\"}","teal":1502},{"pc":[1636],"errorMessage":"transaction verification failed: {\"txn\":\"xfer\",\"field\":\"assetReceiver\",\"expected\":\"this.app.address\"}","teal":1511},{"pc":[1644],"errorMessage":"transaction verification failed: {\"txn\":\"xfer\",\"field\":\"xferAsset\",\"expected\":\"assetB\"}","teal":1520},{"pc":[1651],"errorMessage":"transaction verification failed: {\"txn\":\"xfer\",\"field\":\"assetAmount\",\"condition\":\"greaterThanEqualTo\",\"expected\":\">=0\"}","teal":1529},{"pc":[1671],"errorMessage":"failed to cast txAssetBDeposit to pay","teal":1551},{"pc":[1680],"errorMessage":"transaction verification failed: {\"txn\":\"payTx\",\"field\":\"typeEnum\",\"expected\":\"pay\"}","teal":1566},{"pc":[1688],"errorMessage":"transaction verification failed: {\"txn\":\"payTx\",\"field\":\"receiver\",\"expected\":\"this.app.address\"}","teal":1575},{"pc":[1695],"errorMessage":"transaction verification failed: {\"txn\":\"payTx\",\"field\":\"amount\",\"condition\":\"greaterThanEqualTo\",\"expected\":\">=0\"}","teal":1584},{"pc":[1700],"errorMessage":"Unsupported tx type of the asset B","teal":1593},{"pc":[1710],"errorMessage":"assetLpDelicmalScale2Scale overflowed 256 bits","teal":1607},{"pc":[1745],"errorMessage":"assetLpDelicmalScale2Scale overflowed 256 bits","teal":1649},{"pc":[1761],"errorMessage":"bDepositInBaseScale overflowed 256 bits","teal":1666},{"pc":[1777],"errorMessage":"aDepositInBaseScale overflowed 256 bits","teal":1683},{"pc":[1802],"errorMessage":"assetLpDelicmalScale2Scale overflowed 256 bits","teal":1714},{"pc":[1818],"errorMessage":"bDepositInBaseScale overflowed 256 bits","teal":1731},{"pc":[1834],"errorMessage":"aDepositInBaseScale overflowed 256 bits","teal":1748},{"pc":[1877],"errorMessage":"newPrice as uint64 overflowed 64 bits","teal":1792},{"pc":[1939],"errorMessage":"this.assetABalanceBaseScale.value + realAssetADeposit overflowed 256 bits","teal":1866},{"pc":[1961],"errorMessage":"this.assetBBalanceBaseScale.value + realAssetBDeposit overflowed 256 bits","teal":1891},{"pc":[1997],"errorMessage":"((newLiquidity - oldLiquidity) / assetLpDelicmalScale2Scale) as uint64 overflowed 64 bits","teal":1929},{"pc":[2016],"errorMessage":"LP-ZERO-ERR","teal":1949},{"pc":[2092],"errorMessage":"priceMin overflowed 256 bits","teal":2045},{"pc":[2124],"errorMessage":"priceMax overflowed 256 bits","teal":2073},{"pc":[2140],"errorMessage":"priceMin overflowed 256 bits","teal":2090},{"pc":[2165],"errorMessage":"D_SQRT overflowed 256 bits","teal":2114},{"pc":[2207],"errorMessage":"this.calculateCurrentLiquidity() overflowed 256 bits","teal":2157},{"pc":[2246],"errorMessage":"projectedLiquidity overflowed 256 bits","teal":2202},{"pc":[2279],"errorMessage":"ERR-LIQ-DROP","teal":2239},{"pc":[2347],"errorMessage":"argument 3 (txLpXfer) for removeLiquidity must be a axfer transaction","teal":2323},{"pc":[2363],"errorMessage":"removeLiquidity return value overflowed 256 bits","teal":2341},{"pc":[2399],"errorMessage":"transaction verification failed: {\"txn\":\"txLpXfer\",\"field\":\"assetReceiver\",\"expected\":\"this.app.address\"}","teal":2394},{"pc":[2407],"errorMessage":"transaction verification failed: {\"txn\":\"txLpXfer\",\"field\":\"xferAsset\",\"expected\":\"assetLp\"}","teal":2403},{"pc":[2414],"errorMessage":"transaction verification failed: {\"txn\":\"txLpXfer\",\"field\":\"assetAmount\",\"condition\":\"greaterThanEqualTo\",\"expected\":\">=0\"}","teal":2412},{"pc":[2494],"errorMessage":"lpDelta overflowed 256 bits","teal":2486},{"pc":[2556],"errorMessage":"this.LiquidityUsersFromFees.value - myPortionOfFeesCollected overflowed 256 bits","teal":2548},{"pc":[2578],"errorMessage":"lpDeltaWithFees overflowed 256 bits","teal":2578},{"pc":[2604],"errorMessage":"(aToSend / this.assetADecimalsScaleFromBase.value) as uint64 overflowed 64 bits","teal":2603},{"pc":[2647],"errorMessage":"lpDeltaWithFees overflowed 256 bits","teal":2650},{"pc":[2673],"errorMessage":"(bToSend / this.assetBDecimalsScaleFromBase.value) as uint64 overflowed 64 bits","teal":2675},{"pc":[2717],"errorMessage":"ERR-REM-ZERO","teal":2719},{"pc":[2740],"errorMessage":"newAssetA overflowed 256 bits","teal":2747},{"pc":[2759],"errorMessage":"newAssetB overflowed 256 bits","teal":2769},{"pc":[2792],"errorMessage":"argument 0 (amount) for removeLiquidityAdmin must be a uint256","teal":2811},{"pc":[2816],"errorMessage":"removeLiquidityAdmin return value overflowed 256 bits","teal":2837},{"pc":[2857],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('ef')","teal":2894},{"pc":[2865],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('s')","teal":2904},{"pc":[2872],"errorMessage":"E_PAUSED","teal":2914},{"pc":[2878],"errorMessage":"ERR-EXEC-ONLY","teal":2923},{"pc":[2950],"errorMessage":"ERR-TOO-MUCH","teal":2995},{"pc":[2962],"errorMessage":"this.LiquidityBiatecFromFees.value - lpDeltaWithFees overflowed 256 bits","teal":3010},{"pc":[2984],"errorMessage":"lpDeltaWithFees overflowed 256 bits","teal":3039},{"pc":[3010],"errorMessage":"(aToSend / this.assetADecimalsScaleFromBase.value) as uint64 overflowed 64 bits","teal":3064},{"pc":[3053],"errorMessage":"lpDeltaWithFees overflowed 256 bits","teal":3111},{"pc":[3079],"errorMessage":"(bToSend / this.assetBDecimalsScaleFromBase.value) as uint64 overflowed 64 bits","teal":3136},{"pc":[3132],"errorMessage":"newAssetA overflowed 256 bits","teal":3192},{"pc":[3151],"errorMessage":"newAssetB overflowed 256 bits","teal":3214},{"pc":[3187],"errorMessage":"ERR-INVALID-CONFIG","teal":3270},{"pc":[3194],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('i')","teal":3279},{"pc":[3202],"errorMessage":"ERR-WRONG-IDENT","teal":3292},{"pc":[3255],"errorMessage":"ERR-USER-LOCKED","teal":3346},{"pc":[3270],"errorMessage":"ERR-LOW-VER","teal":3363},{"pc":[3276],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('s')","teal":3372},{"pc":[3283],"errorMessage":"E_PAUSED","teal":3382},{"pc":[3328],"errorMessage":"swap return value overflowed 256 bits","teal":3437},{"pc":[3437],"errorMessage":"Payment can be done only when one of the pool assets is native token","teal":3545},{"pc":[3444],"errorMessage":"transaction verification failed: {\"txn\":\"txSwap\",\"field\":\"typeEnum\",\"expected\":\"pay\"}","teal":3560},{"pc":[3451],"errorMessage":"transaction verification failed: {\"txn\":\"txSwap\",\"field\":\"amount\",\"condition\":\"greaterThan\",\"expected\":\">0\"}","teal":3569},{"pc":[3459],"errorMessage":"transaction verification failed: {\"txn\":\"txSwap\",\"field\":\"receiver\",\"expected\":\"this.app.address\"}","teal":3578},{"pc":[3467],"errorMessage":"transaction verification failed: {\"txn\":\"txSwap\",\"field\":\"sender\",\"expected\":\"this.txn.sender\"}","teal":3587},{"pc":[3486],"errorMessage":"transaction verification failed: {\"txn\":\"txSwap\",\"field\":\"typeEnum\",\"expected\":\"axfer\"}","teal":3613},{"pc":[3493],"errorMessage":"transaction verification failed: {\"txn\":\"txSwap\",\"field\":\"assetAmount\",\"condition\":\"greaterThan\",\"expected\":\">0\"}","teal":3622},{"pc":[3501],"errorMessage":"transaction verification failed: {\"txn\":\"txSwap\",\"field\":\"assetReceiver\",\"expected\":\"this.app.address\"}","teal":3631},{"pc":[3509],"errorMessage":"transaction verification failed: {\"txn\":\"txSwap\",\"field\":\"sender\",\"expected\":\"this.txn.sender\"}","teal":3640},{"pc":[3525],"errorMessage":"transaction verification failed: {\"txn\":{\"txnText\":\"txSwap\"},\"field\":\"xferAsset\",\"condition\":\"includedIn\",\"expected\":\"[assetA, assetB]\"}","teal":3654},{"pc":[3531],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('p')","teal":3664},{"pc":[3539],"errorMessage":"ERR-INVALID-PP","teal":3677},{"pc":[3718],"errorMessage":"inAssetAfterFee overflowed 256 bits","teal":3872},{"pc":[3779],"errorMessage":"realSwapBDecimals as uint64 overflowed 64 bits","teal":3935},{"pc":[3810],"errorMessage":"Minimum to receive is not met","teal":3969},{"pc":[3834],"errorMessage":"this.assetABalanceBaseScale.value + inAssetInBaseScale overflowed 256 bits","teal":3997},{"pc":[3856],"errorMessage":"this.assetBBalanceBaseScale.value - realSwapBaseDecimals overflowed 256 bits","teal":4022},{"pc":[3952],"errorMessage":"inAssetAfterFee overflowed 256 bits","teal":4130},{"pc":[4013],"errorMessage":"realSwapADecimals as uint64 overflowed 64 bits","teal":4193},{"pc":[4044],"errorMessage":"Minimum to receive is not met","teal":4227},{"pc":[4069],"errorMessage":"this.assetBBalanceBaseScale.value + inAssetInBaseScale overflowed 256 bits","teal":4255},{"pc":[4090],"errorMessage":"this.assetABalanceBaseScale.value - realSwapBaseDecimals overflowed 256 bits","teal":4280},{"pc":[4142],"errorMessage":"feeB256 as uint64 overflowed 64 bits","teal":4338},{"pc":[4184],"errorMessage":"feeB256 as uint64 overflowed 64 bits","teal":4382},{"pc":[4205],"errorMessage":"global state value does not exist: this.appBiatecConfigProvider.value.globalState('f')","teal":4404},{"pc":[4231],"errorMessage":"this.LiquidityUsersFromFees.value + usersLiquidityFromFeeIncrement overflowed 256 bits","teal":4434},{"pc":[4274],"errorMessage":"this.LiquidityUsersFromFees.value + usersLiquidityFromFeeIncrement overflowed 256 bits","teal":4479},{"pc":[4296],"errorMessage":"this.LiquidityBiatecFromFees.value + biatecLiquidityFromFeeIncrement overflowed 256 bits","teal":4504},{"pc":[4339],"errorMessage":"Stats to register must not be empty","teal":4555},{"pc":[4348],"errorMessage":"this.assetADecimalsScaleFromBase.value as uint64 overflowed 64 bits","teal":4567},{"pc":[4363],"errorMessage":"this.assetBDecimalsScaleFromBase.value as uint64 overflowed 64 bits","teal":4582},{"pc":[4411],"errorMessage":"newPrice as uint64 overflowed 64 bits","teal":4644},{"pc":[4474],"errorMessage":"newPrice as uint64 overflowed 64 bits","teal":4699},{"pc":[4505],"errorMessage":"argument 0 (amountB) for distributeExcessAssets must be a uint256","teal":4737},{"pc":[4513],"errorMessage":"argument 1 (amountA) for distributeExcessAssets must be a uint256","teal":4747},{"pc":[4533],"errorMessage":"distributeExcessAssets return value overflowed 256 bits","teal":4769},{"pc":[4606],"errorMessage":"E_CONFIG","teal":4849},{"pc":[4612],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('ef')","teal":4858},{"pc":[4620],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('s')","teal":4868},{"pc":[4627],"errorMessage":"E_PAUSED","teal":4878},{"pc":[4633],"errorMessage":"E_SENDER","teal":4890},{"pc":[4644],"errorMessage":"this.assetABalanceBaseScale.value + amountA overflowed 256 bits","teal":4905},{"pc":[4666],"errorMessage":"this.assetBBalanceBaseScale.value + amountB overflowed 256 bits","teal":4930},{"pc":[4700],"errorMessage":"E_A0_B","teal":4971},{"pc":[4719],"errorMessage":"E_A_B","teal":4994},{"pc":[4736],"errorMessage":"E_B_B","teal":5016},{"pc":[4762],"errorMessage":"global state value does not exist: this.appBiatecConfigProvider.value.globalState('f')","teal":5045},{"pc":[4788],"errorMessage":"this.LiquidityUsersFromFees.value + usersLiquidityFromFeeIncrement overflowed 256 bits","teal":5075},{"pc":[4831],"errorMessage":"this.LiquidityUsersFromFees.value + usersLiquidityFromFeeIncrement overflowed 256 bits","teal":5120},{"pc":[4853],"errorMessage":"this.LiquidityBiatecFromFees.value + biatecLiquidityFromFeeIncrement overflowed 256 bits","teal":5145},{"pc":[4892],"errorMessage":"newPrice as uint64 overflowed 64 bits","teal":5189},{"pc":[4961],"errorMessage":"E_CONFIG","teal":5281},{"pc":[4967],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('ef')","teal":5290},{"pc":[4975],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('s')","teal":5300},{"pc":[4982],"errorMessage":"E_PAUSED","teal":5310},{"pc":[4988],"errorMessage":"E_SENDER","teal":5322},{"pc":[5044],"errorMessage":"E_A0_B","teal":5387},{"pc":[5063],"errorMessage":"E_A_B","teal":5410},{"pc":[5080],"errorMessage":"E_B_B","teal":5432},{"pc":[5144],"errorMessage":"E_CONFIG","teal":5505},{"pc":[5150],"errorMessage":"global state value does not exist: appBiatecConfigProvider.globalState('ef')","teal":5514},{"pc":[5158],"errorMessage":"E_SENDER","teal":5527},{"pc":[5203],"errorMessage":"argument 0 (currentDeposit) for calculateDistributedLiquidity must be a uint256","teal":5595},{"pc":[5215],"errorMessage":"calculateDistributedLiquidity return value overflowed 256 bits","teal":5609},{"pc":[5290],"errorMessage":"argument 0 (price) for calculateLiquidityFlatPrice must be a uint256","teal":5701},{"pc":[5298],"errorMessage":"argument 1 (y) for calculateLiquidityFlatPrice must be a uint256","teal":5711},{"pc":[5306],"errorMessage":"argument 2 (x) for calculateLiquidityFlatPrice must be a uint256","teal":5721},{"pc":[5314],"errorMessage":"calculateLiquidityFlatPrice return value overflowed 256 bits","teal":5731},{"pc":[5351],"errorMessage":"argument 0 (priceMaxSqrt) for calculateLiquidityD must be a uint256","teal":5774},{"pc":[5359],"errorMessage":"argument 1 (priceMinSqrt) for calculateLiquidityD must be a uint256","teal":5784},{"pc":[5367],"errorMessage":"argument 2 (priceMax) for calculateLiquidityD must be a uint256","teal":5794},{"pc":[5375],"errorMessage":"argument 3 (priceMin) for calculateLiquidityD must be a uint256","teal":5804},{"pc":[5383],"errorMessage":"argument 4 (y) for calculateLiquidityD must be a uint256","teal":5814},{"pc":[5391],"errorMessage":"argument 5 (x) for calculateLiquidityD must be a uint256","teal":5824},{"pc":[5399],"errorMessage":"calculateLiquidityD return value overflowed 256 bits","teal":5834},{"pc":[5538],"errorMessage":"argument 0 (dSqrt) for calculateLiquidityWithD must be a uint256","teal":5987},{"pc":[5546],"errorMessage":"argument 1 (priceMaxSqrt) for calculateLiquidityWithD must be a uint256","teal":5997},{"pc":[5554],"errorMessage":"argument 2 (priceMinSqrt) for calculateLiquidityWithD must be a uint256","teal":6007},{"pc":[5562],"errorMessage":"argument 3 (y) for calculateLiquidityWithD must be a uint256","teal":6017},{"pc":[5570],"errorMessage":"argument 4 (x) for calculateLiquidityWithD must be a uint256","teal":6027},{"pc":[5578],"errorMessage":"calculateLiquidityWithD return value overflowed 256 bits","teal":6037},{"pc":[5727],"errorMessage":"argument 0 (liquidity) for calculatePrice must be a uint256","teal":6208},{"pc":[5735],"errorMessage":"argument 1 (priceMaxSqrt) for calculatePrice must be a uint256","teal":6218},{"pc":[5743],"errorMessage":"argument 2 (priceMinSqrt) for calculatePrice must be a uint256","teal":6228},{"pc":[5751],"errorMessage":"argument 3 (assetBQuantity) for calculatePrice must be a uint256","teal":6238},{"pc":[5759],"errorMessage":"argument 4 (assetAQuantity) for calculatePrice must be a uint256","teal":6248},{"pc":[5767],"errorMessage":"calculatePrice return value overflowed 256 bits","teal":6258},{"pc":[5874],"errorMessage":"argument 0 (liquidity) for calculateAssetBWithdrawOnAssetADeposit must be a uint256","teal":6389},{"pc":[5882],"errorMessage":"argument 1 (priceMaxSqrt) for calculateAssetBWithdrawOnAssetADeposit must be a uint256","teal":6399},{"pc":[5890],"errorMessage":"argument 2 (priceMinSqrt) for calculateAssetBWithdrawOnAssetADeposit must be a uint256","teal":6409},{"pc":[5898],"errorMessage":"argument 3 (assetBBalance) for calculateAssetBWithdrawOnAssetADeposit must be a uint256","teal":6419},{"pc":[5906],"errorMessage":"argument 4 (assetABalance) for calculateAssetBWithdrawOnAssetADeposit must be a uint256","teal":6429},{"pc":[5914],"errorMessage":"argument 5 (inAmount) for calculateAssetBWithdrawOnAssetADeposit must be a uint256","teal":6439},{"pc":[5922],"errorMessage":"calculateAssetBWithdrawOnAssetADeposit return value overflowed 256 bits","teal":6449},{"pc":[6062],"errorMessage":"argument 0 (liquidity) for calculateAssetAWithdrawOnAssetBDeposit must be a uint256","teal":6608},{"pc":[6070],"errorMessage":"argument 1 (priceMaxSqrt) for calculateAssetAWithdrawOnAssetBDeposit must be a uint256","teal":6618},{"pc":[6078],"errorMessage":"argument 2 (priceMinSqrt) for calculateAssetAWithdrawOnAssetBDeposit must be a uint256","teal":6628},{"pc":[6086],"errorMessage":"argument 3 (assetBBalance) for calculateAssetAWithdrawOnAssetBDeposit must be a uint256","teal":6638},{"pc":[6094],"errorMessage":"argument 4 (assetABalance) for calculateAssetAWithdrawOnAssetBDeposit must be a uint256","teal":6648},{"pc":[6102],"errorMessage":"argument 5 (inAmount) for calculateAssetAWithdrawOnAssetBDeposit must be a uint256","teal":6658},{"pc":[6110],"errorMessage":"calculateAssetAWithdrawOnAssetBDeposit return value overflowed 256 bits","teal":6668},{"pc":[6274],"errorMessage":"argument 0 (liquidity) for calculateAssetAWithdrawOnLpDeposit must be a uint256","teal":6857},{"pc":[6282],"errorMessage":"argument 1 (assetABalance) for calculateAssetAWithdrawOnLpDeposit must be a uint256","teal":6867},{"pc":[6290],"errorMessage":"argument 2 (inAmount) for calculateAssetAWithdrawOnLpDeposit must be a uint256","teal":6877},{"pc":[6298],"errorMessage":"calculateAssetAWithdrawOnLpDeposit return value overflowed 256 bits","teal":6887},{"pc":[6340],"errorMessage":"argument 0 (assetBBalance) for calculateAssetBDepositOnAssetADeposit must be a uint256","teal":6946},{"pc":[6348],"errorMessage":"argument 1 (assetABalance) for calculateAssetBDepositOnAssetADeposit must be a uint256","teal":6956},{"pc":[6356],"errorMessage":"argument 2 (inAmountB) for calculateAssetBDepositOnAssetADeposit must be a uint256","teal":6966},{"pc":[6364],"errorMessage":"argument 3 (inAmountA) for calculateAssetBDepositOnAssetADeposit must be a uint256","teal":6976},{"pc":[6372],"errorMessage":"calculateAssetBDepositOnAssetADeposit return value overflowed 256 bits","teal":6986},{"pc":[6418],"errorMessage":"argument 0 (assetBBalance) for calculateAssetADepositOnAssetBDeposit must be a uint256","teal":7053},{"pc":[6426],"errorMessage":"argument 1 (assetABalance) for calculateAssetADepositOnAssetBDeposit must be a uint256","teal":7063},{"pc":[6434],"errorMessage":"argument 2 (inAmountB) for calculateAssetADepositOnAssetBDeposit must be a uint256","teal":7073},{"pc":[6442],"errorMessage":"argument 3 (inAmountA) for calculateAssetADepositOnAssetBDeposit must be a uint256","teal":7083},{"pc":[6450],"errorMessage":"calculateAssetADepositOnAssetBDeposit return value overflowed 256 bits","teal":7093},{"pc":[6524],"errorMessage":"E_CONFIG","teal":7194},{"pc":[6545],"errorMessage":"E_LP","teal":7220},{"pc":[6552],"errorMessage":"global state value does not exist: this.appBiatecConfigProvider.value.globalState('f')","teal":7230},{"pc":[6624],"errorMessage":"this.assetABalanceBaseScale.value as uint64 overflowed 64 bits","teal":7317},{"pc":[6639],"errorMessage":"this.assetBBalanceBaseScale.value as uint64 overflowed 64 bits","teal":7330},{"pc":[6662],"errorMessage":"this.priceMinSqrt.value as uint64 overflowed 64 bits","teal":7349},{"pc":[6677],"errorMessage":"this.priceMaxSqrt.value as uint64 overflowed 64 bits","teal":7362},{"pc":[6692],"errorMessage":"this.Liquidity.value as uint64 overflowed 64 bits","teal":7375},{"pc":[6711],"errorMessage":"this.calculateDistributedLiquidity(assetLp, <uint256>0) as uint64 overflowed 64 bits","teal":7389},{"pc":[6734],"errorMessage":"this.LiquidityUsersFromFees.value as uint64 overflowed 64 bits","teal":7410},{"pc":[6749],"errorMessage":"this.LiquidityBiatecFromFees.value as uint64 overflowed 64 bits","teal":7423},{"pc":[6788],"errorMessage":"biatecFee as uint64 overflowed 64 bits","teal":7455},{"pc":[6818],"errorMessage":"this contract does not implement the given ABI method for create NoOp","teal":7478},{"pc":[7008],"errorMessage":"this contract does not implement the given ABI method for call NoOp","teal":7508},{"pc":[7022],"errorMessage":"this contract does not implement the given ABI method for call UpdateApplication","teal":7516}],"pcOffsetMethod":"none"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}},"source":{"approval":"","clear":"I3ByYWdtYSB2ZXJzaW9uIDEw"},"byteCode":{"approval":"","clear":"Cg=="}} as unknown as Arc56Contract
