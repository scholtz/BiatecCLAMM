...
## Why an allowance is needed at all {#-why-an-allowance-is-needed-at-all}
...
## Rationale for the chosen formula {#-rationale-for-the-chosen-formula}
...
## Files & symbols changed (quick reference) {#-files--symbols-changed-quick-reference}
...
## How to reproduce the original failing symptom {#-how-to-reproduce-the-original-failing-symptom}
...
## Decision log / trade-offs {#-decision-log--trade-offs}
