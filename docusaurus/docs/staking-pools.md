...
### 2. Asset Staking (B-USDC, B-TOKEN, etc.) {#-2-asset-staking-b-usdc-b-token-etc}
...
## Pool Characteristics {#-pool-characteristics}
...
### 2. Adding Liquidity (Staking) {#-2-adding-liquidity-staking}
...
### 3. Distributing Rewards {#-3-distributing-rewards}
...
### 4. Removing Liquidity (Unstaking) {#-4-removing-liquidity-unstaking}
...
### TypeScript API Changes {#-typescript-api-changes}
...
### Example 1: B-ALGO Pool {#-example-1-b-algo-pool}
...
### Example 2: B-USDC Pool (Lending Protocol) {#-example-2-b-usdc-pool-lending-protocol}
...
### Differences from Liquidity Pools {#-differences-from-liquidity-pools}
...
### Example Safe Reward Distribution {#-example-safe-reward-distribution}
