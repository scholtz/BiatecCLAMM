# Class: BiatecPoolProviderFactory
...
> **new BiatecPoolProviderFactory**(`params`): `BiatecPoolProviderFactory`
...
> **createApplication**: (`params`) => `Promise`\<\{ `result`: \{ `return`: `void` \| `undefined`; \}; `appClient`: [`BiatecPoolProviderClient`](BiatecPoolProviderClient.md); \}\>
...
`Promise`\<\{ `result`: \{ `return`: `void` \| `undefined`; \}; `appClient`: [`BiatecPoolProviderClient`](BiatecPoolProviderClient.md); \}\>
...
> **getAppClientById**(`params`): [`BiatecPoolProviderClient`](BiatecPoolProviderClient.md)
...
[`BiatecPoolProviderClient`](BiatecPoolProviderClient.md)
...
> **getAppClientByCreatorAndName**(`params`): `Promise`\<[`BiatecPoolProviderClient`](BiatecPoolProviderClient.md)\>
...
`Promise`\<[`BiatecPoolProviderClient`](BiatecPoolProviderClient.md)\>
...
> **deploy**(`params`): `Promise`\<\{ `result`: \{ \} \| \{ \} \| \{ \} \| \{ \}; `appClient`: [`BiatecPoolProviderClient`](BiatecPoolProviderClient.md); \}\>
...
`BiatecPoolProviderCreateCallParams`

Create transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)

###### updateParams?

`BiatecPoolProviderUpdateCallParams`

Update transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)

#### Returns

`Promise`\<\{ `result`: \{ \} \| \{ \} \| \{ \} \| \{ \}; `appClient`: [`BiatecPoolProviderClient`](BiatecPoolProviderClient.md); \}\>
