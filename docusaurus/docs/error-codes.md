...
## Core Contract Errors {#-core-contract-errors}
...
#### Identity and Verification Errors {#-identity-and-verification-errors}
...
### Pool Creation Failures {#-pool-creation-failures}
...
### Liquidity Provision Failures {#-liquidity-provision-failures}
...
### Administrative Operation Failures {#-administrative-operation-failures}
...
### Finding Error Context {#-finding-error-context}
...
### For Recoverable Errors {#-for-recoverable-errors}
...
### For Unrecoverable Errors {#-for-unrecoverable-errors}
