# Class: BiatecConfigProviderFactory
...
> **new BiatecConfigProviderFactory**(`params`): `BiatecConfigProviderFactory`
...
> **createApplication**: (`params`) => `Promise`\<\{ `result`: \{ `return`: `void` \| `undefined`; \}; `appClient`: [`BiatecConfigProviderClient`](BiatecConfigProviderClient.md); \}\>
...
`Promise`\<\{ `result`: \{ `return`: `void` \| `undefined`; \}; `appClient`: [`BiatecConfigProviderClient`](BiatecConfigProviderClient.md); \}\>
...
> **getAppClientById**(`params`): [`BiatecConfigProviderClient`](BiatecConfigProviderClient.md)
...
[`BiatecConfigProviderClient`](BiatecConfigProviderClient.md)
...
> **getAppClientByCreatorAndName**(`params`): `Promise`\<[`BiatecConfigProviderClient`](BiatecConfigProviderClient.md)\>
...
`Promise`\<[`BiatecConfigProviderClient`](BiatecConfigProviderClient.md)\>
...
> **deploy**(`params`): `Promise`\<\{ `result`: \{ \} \| \{ \} \| \{ \} \| \{ \}; `appClient`: [`BiatecConfigProviderClient`](BiatecConfigProviderClient.md); \}\>
...
`BiatecConfigProviderCreateCallParams`

Create transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)

###### updateParams?

`BiatecConfigProviderUpdateCallParams`

Update transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)

#### Returns

`Promise`\<\{ `result`: \{ \} \| \{ \} \| \{ \} \| \{ \}; `appClient`: [`BiatecConfigProviderClient`](BiatecConfigProviderClient.md); \}\>
