...
> **new BiatecIdentityProviderFactory**(`params`): `BiatecIdentityProviderFactory`
...
> **createApplication**: (`params`) => `Promise`\<\{ `result`: \{ `return`: `void` \| `undefined`; \}; `appClient`: [`BiatecIdentityProviderClient`](BiatecIdentityProviderClient.md); \}\>
...
`Promise`\<\{ `result`: \{ `return`: `void` \| `undefined`; \}; `appClient`: [`BiatecIdentityProviderClient`](BiatecIdentityProviderClient.md); \}\>
...
> **getAppClientById**(`params`): [`BiatecIdentityProviderClient`](BiatecIdentityProviderClient.md)
...
[`BiatecIdentityProviderClient`](BiatecIdentityProviderClient.md)
...
> **getAppClientByCreatorAndName**(`params`): `Promise`\<[`BiatecIdentityProviderClient`](BiatecIdentityProviderClient.md)\>
...
`Promise`\<[`BiatecIdentityProviderClient`](BiatecIdentityProviderClient.md)\>
...
> **deploy**(`params`): `Promise`\<\{ `result`: \{ \} \| \{ \} \| \{ \} \| \{ \}; `appClient`: [`BiatecIdentityProviderClient`](BiatecIdentityProviderClient.md); \}\>
...
`BiatecIdentityProviderCreateCallParams`

Create transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)

###### updateParams?

`BiatecIdentityProviderUpdateCallParams`

Update transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)

#### Returns

`Promise`\<\{ `result`: \{ \} \| \{ \} \| \{ \} \| \{ \}; `appClient`: [`BiatecIdentityProviderClient`](BiatecIdentityProviderClient.md); \}\>
