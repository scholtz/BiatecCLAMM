...
(
  module.exports = {
    ...
    themeConfig:
      ...
      ({
        // Enable Algolia DocSearch (only if environment variables are available)
        ...(process.env.appId || process.env.ALGOLIA_APP_ID
          ? {
              algolia: {
                // The application ID provided by Algolia
                appId: process.env.appId || process.env.ALGOLIA_APP_ID,
                // Public API key: it is safe to commit it
                apiKey: process.env.apiKey || process.env.ALGOLIA_API_KEY,
                indexName: process.env.indexName || process.env.ALGOLIA_INDEX_NAME || 'biatec-dex',
